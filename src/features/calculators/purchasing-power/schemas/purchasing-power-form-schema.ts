...
export const PurchasingPowerFormSchema = z
  .object({
    startMonth: z.number(),
    startYear: z.number(),
    endMonth: z.number(),
    ...
    endAmount: z.number("Debe ser un número").min(0, "Debe ser positivo"),
  })
  .refine(
    (data) => {
...
export type PurchasingPowerFormType = z.infer<typeof PurchasingPowerFormSchema>;
