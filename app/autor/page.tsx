    ...
    <main className="mx-auto px-4 py-16 flex flex-col gap-8">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-text-secondary leading-relaxed">
          ...
          oficiales del Banco Central de la República Argentina (BCRA), el Ministerio
          de Economía - Secretaría de Obras Públicas y el Instituto Nacional de
          Estadística y Censos (INDEC) para ofrecer datos precisos
          y herramientas de análisis de la economía Argentina.
        </p>
      </div>

      <section>
        <Subtitle subtitle="Contacto y links útiles"/>
        <div className="flex flex-col gap-2 max-w-md ml-2">
          {[
